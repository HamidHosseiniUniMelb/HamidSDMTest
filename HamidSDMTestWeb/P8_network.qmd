...
::: {.callout-note}
# pgr_createTopology and pgr_extractVertices
...
Using vertices_table, now you can enrich the edge table by adding source (id ,x1,y1), target(id x2,y2), cost, reverse_cost and build the topology table for your network as follows:
...
```
Once the columns updated, the full suite of pgRouting functions (e.g., pgr_dijkstra for shortest path analysis) can be applied to perform network analysis.
:::
