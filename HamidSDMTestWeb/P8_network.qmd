...
```sql
-- Add the source, target, x1, y1, x2, y2, and cost columns to your_edge_table 
...
-- Populate the columns using the outgoing and incoming edges from the vertices table:
WITH out_going AS (
