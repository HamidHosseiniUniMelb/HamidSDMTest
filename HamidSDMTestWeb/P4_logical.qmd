...
## 4. DuckDB with Python

You can run Python code to interact with DuckDB directly.  
The following example creates a simple table, inserts data, and queries it.
...
# Or, connect to a persistent file-based database
# con = duckdb.connect(database='my_database.duckdb', read_only=False)

# Example: create a simple table and query it
con.execute("CREATE TABLE people (name VARCHAR, age INTEGER)")
con.execute("INSERT INTO people VALUES ('Hamid', 32), ('Sara', 29)")
